<?php
	...
	/**
	 * Central phpPgAdmin configuration for the platform admin proxy.
	 *
	 * This mirrors the upstream image default config and only tightens the
	 * database browser so app-scoped logins do not list unrelated databases.
	 */
	...
	// Note: this hides other databases from the browser tree for app-scoped
	// phpPgAdmin sessions. PostgreSQL permissions are still the real boundary.
