...
printf '%s\n' '[+] safety old-space-limit=64MiB network=unused fixtures=bounded-local-only'
node --max-old-space-size=64 "$SCRIPT_DIR/project-metadata-budget-probe.mjs" "$TMP/source" "$TMP/fixtures"
