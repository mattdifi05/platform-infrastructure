...
| 3 | Admin passkey | Direct SimpleWebAuthn verification, opaque PostgreSQL sessions, exact host/origin checks, CSRF and recent-auth gates are fail-closed. | One enrolled passkey is sufficient; the Control Center has no Keycloak/OIDC handoff and sessions expire after one day. |
