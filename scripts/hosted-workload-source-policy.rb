...
module HostedWorkloadSourcePolicy
  ...
  CONTROLS = %w[deny-api-socket deny-device-access deny-env-file deny-extends deny-file-configs deny-include deny-lifecycle-hooks deny-local-volume-options deny-scaling deny-volumes-from].freeze
