...
for key in \
  ACCOUNT_HOST API_HOST AUTH_HOST CONTROL_CENTER_HOST DOCS_HOST PROJECTS_WILDCARD_HOST_REGEXP \
  API_PUBLIC_URL ACCOUNT_PUBLIC_URL UI_PUBLIC_URL CONTROL_CENTER_PUBLIC_URL DOCS_PUBLIC_URL NEXT_PUBLIC_API_URL NEXT_PUBLIC_UI_URL NEXT_PUBLIC_ACCOUNT_URL \
