...
COMMAND=${2:-verify}
RAW_POLICY_CONTROLS='["deny-device-access","deny-env-file","deny-extends","deny-file-configs","deny-include","deny-lifecycle-hooks","deny-local-volume-options","deny-scaling","deny-volumes-from"]'
