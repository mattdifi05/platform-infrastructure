...
function staticSecurityInfraOnlyCheck() {
  ...
  assertMatch(controlCenterTest, /\/control\/advanced[\s\S]*\/control\/advanced\/cloudflare[\s\S]*\/control\/advanced\/release-evidence[\s\S]*\/control\/advanced\/identity[\s\S]*\/control\/advanced\/secrets/, "Control Center tests must cover Advanced Mode API evidence endpoints.");
