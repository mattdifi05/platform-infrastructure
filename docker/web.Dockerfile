...
ARG NEXT_PUBLIC_ACCOUNT_URL=https://auth.localhost.com
ARG NEXT_PUBLIC_BOT_PROTECTION_PROVIDER=disabled
ARG NEXT_PUBLIC_CLOUDFLARE_TURNSTILE_SITE_KEY=
ARG ACCOUNT_HOST=auth.localhost.com
ARG ACCOUNT_PUBLIC_URL=https://auth.localhost.com
ARG NEXTAUTH_URL=https://auth.localhost.com
