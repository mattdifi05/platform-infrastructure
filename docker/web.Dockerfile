...
ARG NEXT_PUBLIC_APP_URL=https://app.localhost.com
ARG NEXT_PUBLIC_ACCOUNT_URL=https://account.localhost.com
ARG NEXT_PUBLIC_DB_CONSOLE_URL=https://db.localhost.com
ARG NEXT_PUBLIC_DB_CONSOLE_ALLOWED_EMAIL=
ARG NEXT_PUBLIC_DB_CONSOLE_ENABLED=false
...
ARG DB_CONSOLE_ENABLED=false
ARG ACCOUNT_HOST=account.localhost.com
ARG DB_CONSOLE_HOST=db.localhost.com
...
ENV NODE_ENV=production \
    ...
    NEXT_PUBLIC_DB_CONSOLE_URL=${NEXT_PUBLIC_DB_CONSOLE_URL} \
    NEXT_PUBLIC_DB_CONSOLE_ALLOWED_EMAIL=${NEXT_PUBLIC_DB_CONSOLE_ALLOWED_EMAIL} \
    NEXT_PUBLIC_DB_CONSOLE_ENABLED=${NEXT_PUBLIC_DB_CONSOLE_ENABLED} \
    ...
    DB_CONSOLE_ENABLED=${DB_CONSOLE_ENABLED} \
    ACCOUNT_HOST=${ACCOUNT_HOST} \
    DB_CONSOLE_HOST=${DB_CONSOLE_HOST} \
